...
text(allH(1), -1800, 6.5, 'a)', 'FontSize', 12, 'FontWeight', 'bold', 'FontName', 'CMUBright');
...
text(allH(2), -1800, 6.5, 'b)', 'FontSize', 12, 'FontWeight', 'bold', 'FontName', 'CMUBright');
...
text(allH(3), -1800, 6.5, 'c)', 'FontSize', 12, 'FontWeight', 'bold', 'FontName', 'CMUBright');
...
text(allH(4), -1800, 6.5, 'd)', 'FontSize', 12, 'FontWeight', 'bold', 'FontName', 'CMUBright');
...
%%
print('/Applications/Projects/2023-01-31_FEMAExperiments/2023-11-20_redone/Figures/Results03-Comparison_ComputationalTime_AE-FAE-SAE-FASE.png', '-dpng', '-r900');
close(fig);